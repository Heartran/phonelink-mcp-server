...
export const GetStatusInputSchema = z.object({}).strict().describe("No parameters required. Returns Phone Link connection status.");
...
export const LaunchAppInputSchema = z.object({}).strict().describe("No parameters required. Launches Phone Link if not already running.");
